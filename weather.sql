...
-- Dumping structure for table weather.history
CREATE TABLE IF NOT EXISTS `history` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `cid` varchar(20) NOT NULL DEFAULT '',
  `isUse` int(1) NOT NULL DEFAULT '0' COMMENT '是否当前',
  `name` varchar(50) NOT NULL DEFAULT '',
  `now` text NOT NULL,
  `airNow` text NOT NULL,
...
-- Dumping data for table weather.history: ~0 rows (大约)
DELETE FROM `history`;
/*!40000 ALTER TABLE `history` DISABLE KEYS */;
/*!40000 ALTER TABLE `history` ENABLE KEYS */;

-- Dumping structure for table weather.region
...
-- Dumping data for table weather.region: ~3,218 rows (大约)
DELETE FROM `region`;
/*!40000 ALTER TABLE `region` DISABLE KEYS */;
INSERT INTO `region` (`id`, `name`, `level`, `parentId`, `cid`) VALUES
	(110000, '北京市', 1, 0, ''),
	(110101, '东城区', 3, 110000, 'CN101011600'),
	(110102, '西城区', 3, 110000, 'CN101011700'),
	(110105, '朝阳区', 3, 110000, 'CN101010300'),
	(110106, '丰台区', 3, 110000, ''),
	...
	(110119, '延庆区', 3, 110000, ''),
	(120000, '天津市', 1, 0, ''),
	(120101, '和平区', 3, 120000, 'CN101070107'),
	(120102, '河东区', 3, 120000, 'CN101120913'),
	(120103, '河西区', 3, 120000, ''),
	(120104, '南开区', 3, 120000, ''),
	(120105, '河北区', 3, 120000, ''),
	(120106, '红桥区', 3, 120000, ''),
	...
	(140404, '上党区', 3, 140400, ''),
	(140405, '屯留区', 3, 140400, ''),
	(140406, '潞城区', 3, 140400, 'CN101100504'),
	(140423, '襄垣县', 3, 140400, ''),
	(140425, '平顺县', 3, 140400, ''),
	(140426, '黎城县', 3, 140400, ''),
	(140427, '壶关县', 3, 140400, ''),
	...
	(150102, '新城区', 3, 150100, 'CN101110108'),
	(150103, '回民区', 3, 150100, ''),
	(150104, '玉泉区', 3, 150100, ''),
	(150105, '赛罕区', 3, 150100, ''),
	...
	(150200, '包头市', 2, 150000, ''),
	(150202, '东河区', 3, 150200, ''),
	(150203, '昆都仑区', 3, 150200, 'CN101080209'),
	(150204, '青山区', 3, 150200, ''),
	(150205, '石拐区', 3, 150200, ''),
	(150206, '白云鄂博矿区', 3, 150200, ''),
	(150207, '九原区', 3, 150200, 'CN101080212'),
	(150221, '土默特右旗', 3, 150200, 'CN101080204'),
	(150222, '固阳县', 3, 150200, ''),
	...
	(210000, '辽宁省', 1, 0, ''),
	(210100, '沈阳市', 2, 210000, ''),
	(210102, '和平区', 3, 210100, 'CN101070107'),
	(210103, '沈河区', 3, 210100, ''),
	(210104, '大东区', 3, 210100, ''),
	(210105, '皇姑区', 3, 210100, ''),
	(210106, '铁西区', 3, 210100, ''),
	...
	(220100, '长春市', 2, 220000, ''),
	(220102, '南关区', 3, 220100, ''),
	(220103, '宽城区', 3, 220100, 'CN101060109'),
	(220104, '朝阳区', 3, 220100, 'CN101010300'),
	(220105, '二道区', 3, 220100, 'CN101060107'),
	(220106, '绿园区', 3, 220100, ''),
	(220112, '双阳区', 3, 220100, 'CN101060106'),
	(220113, '九台区', 3, 220100, 'CN101060104'),
	(220122, '农安县', 3, 220100, 'CN101060102'),
	(220182, '榆树市', 3, 220100, 'CN101060105'),
	(220183, '德惠市', 3, 220100, 'CN101060103'),
	(220200, '吉林市', 2, 220000, ''),
	(220202, '昌邑区', 3, 220200, ''),
	(220203, '龙潭区', 3, 220200, ''),
	(220204, '船营区', 3, 220200, ''),
	...
	(330881, '江山市', 3, 330800, ''),
	(330900, '舟山市', 2, 330000, ''),
	(330902, '定海区', 3, 330900, 'CN101211106'),
	(330903, '普陀区', 3, 330900, ''),
	(330921, '岱山县', 3, 330900, ''),
	(330922, '嵊泗县', 3, 330900, ''),
	(331000, '台州市', 2, 330000, ''),
	...
	(350824, '武平县', 3, 350800, ''),
	(350825, '连城县', 3, 350800, ''),
	(350881, '漳平市', 3, 350800, 'CN101230707'),
	(350900, '宁德市', 2, 350000, ''),
	(350902, '蕉城区', 3, 350900, ''),
	(350921, '霞浦县', 3, 350900, ''),
	(350922, '古田县', 3, 350900, ''),
	...
	(371200, '莱芜市', 2, 370000, ''),
	(371202, '莱城区', 3, 371200, ''),
	(371203, '钢城区', 3, 371200, 'CN101121603'),
	(371300, '临沂市', 2, 370000, ''),
	(371302, '兰山区', 3, 371300, ''),
	(371311, '罗庄区', 3, 371300, ''),
	(371312, '河东区', 3, 371300, 'CN101120913'),
	(371321, '沂南县', 3, 371300, ''),
	(371322, '郯城县', 3, 371300, ''),
	(371323, '沂水县', 3, 371300, ''),
	(371324, '兰陵县', 3, 371300, ''),
	...
	(450423, '蒙山县', 3, 450400, ''),
	(450481, '岑溪市', 3, 450400, ''),
	(450500, '北海市', 2, 450000, 'CN101301301'),
	(450502, '海城区', 3, 450500, ''),
	(450503, '银海区', 3, 450500, ''),
	...
	(450681, '东兴市', 3, 450600, ''),
	(450700, '钦州市', 2, 450000, ''),
	(450702, '钦南区', 3, 450700, 'CN101301104'),
	(450703, '钦北区', 3, 450700, 'CN101301105'),
	(450721, '灵山县', 3, 450700, 'CN101301103'),
	(450722, '浦北县', 3, 450700, ''),
	(450800, '贵港市', 2, 450000, ''),
	(450802, '港北区', 3, 450800, ''),
	(450803, '港南区', 3, 450800, ''),
	...
	(469023, '澄迈县', 3, 469000, ''),
	(469024, '临高县', 3, 469000, ''),
	(469025, '白沙黎族自治县', 3, 469000, ''),
	(469026, '昌江黎族自治县', 3, 469000, ''),
	(469027, '乐东黎族自治县', 3, 469000, ''),
	(469028, '陵水黎族自治县', 3, 469000, ''),
	(469029, '保亭黎族苗族自治县', 3, 469000, ''),
	(469030, '琼中黎族苗族自治县', 3, 469000, ''),
	(500000, '重庆市', 1, 0, ''),
	(500101, '万州区', 3, 500000, ''),
	(500102, '涪陵区', 3, 500000, ''),
	(500103, '渝中区', 3, 500000, ''),
	...
	(500237, '巫山县', 3, 500000, ''),
	(500238, '巫溪县', 3, 500000, ''),
	(500240, '石柱土家族自治县', 3, 500000, ''),
	(500241, '秀山土家族苗族自治县', 3, 500000, ''),
	(500242, '酉阳土家族苗族自治县', 3, 500000, ''),
	(500243, '彭水苗族土家族自治县', 3, 500000, ''),
	(510000, '四川省', 1, 0, ''),
	(510100, '成都市', 2, 510000, ''),
	(510104, '锦江区', 3, 510100, ''),
	(510105, '青羊区', 3, 510100, ''),
	...
	(610000, '陕西省', 1, 0, ''),
	(610100, '西安市', 2, 610000, ''),
	(610102, '新城区', 3, 610100, 'CN101110108'),
	(610103, '碑林区', 3, 610100, ''),
	(610104, '莲湖区', 3, 610100, ''),
	(610111, '灞桥区', 3, 610100, ''),
	(610112, '未央区', 3, 610100, ''),
